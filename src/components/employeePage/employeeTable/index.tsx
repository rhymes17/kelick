...
export const EmployeeTable: React.FC<EmployeeTableProps> = () => {
  ...
  return (
    <div className="w-full rounded-xl border-[1px] border-gray-200">
      {dataLength > 0 && (
        <table className="divide-solid w-full divide-y-[1px] divide-gray-200">
          <thead>
            <tr className="flex items-center justify-between font-medium text-gray-400 bg-surface-2 rounded-xl">
              <td className="px-3 pb-3 pt-4">
                <input
                  type="checkbox"
                  className="h-5 w-5 appearance-none rounded-md border-[2px] border-gray-200"
                />
              </td>
          ...
          <tbody className="divide-y-[1px] divide-solid divide-gray-200">
            {Employees.map((employee, index) => (
              <tr className="flex items-center justify-between text-left text-sm font-semibold leading-5 text-gray-900">
                ...
                <td className="w-full px-3 flex items-center text-brand-active underline">
                  {employee.id}
                </td>
